     ...
     <div className="flex flex-col h-full">
      <header className="p-4 border-b flex items-center justify-between bg-card fixed top-0 w-full z-10 md:relative">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-semibold font-headline">Accounts</h1>
        </div>
      </header>
      <main className="flex-1 p-4 md:p-8 pt-20 md:pt-8 flex items-center justify-center">
        <Card className="w-full max-w-lg text-center">
            <CardHeader>
                ...
                <CardTitle className="font-headline mt-4">Account Management</CardTitle>
                <CardDescription>
                    This is where you'll manage your company and business accounts.
                </CardDescription>
            </CardHeader>
            <CardContent>
